    ...
    <Pressable onPress={Keyboard.dismiss} style={styles.container}>
      ...
      <View style={styles.AreaTxt}>
        <Text style={styles.txt}>
          O IMC é um cálculo simples que permite {'\n'} avaliar se a pessoa está dentro do
          peso que {'\n'}é considerado ideal para a sua altura.
        </Text>
      </View>
      <Animatable.View animation='fadeInUpBig' delay={600} style={styles.AreaInput}>
        ...
        <TouchableOpacity style={styles.AreaBtn} onPress={() => validationImc()}>
          <Text style={styles.BtnTxt}>{textButton}</Text>
        </TouchableOpacity>
        <ResultImc messageResultImc={messageImc} resultImc={imc} />
        <View style={styles.AreaLine}>
          <View style={styles.LineViewLeft} />
          <TouchableOpacity style={styles.AreaInfo} onPress={goInformativeScreen}>
